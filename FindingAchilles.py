    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if pre_tag:
                ...
                print("No <pre> tags found in the HTML.")
        else:
...
if __name__ == "__main__":
    print("CVE and Exploit Finder Script")
    print("This script searches for CVEs, exploits, and possible 0-Days for any product.\n")

    component = input("Enter the component (e.g., Apache): ")
    version = input("Enter the version (e.g., 4.2.1): ")
    ...
    if marc_info:
        print("\nExploits found in Marc Full Disclosure")
        for result in marc_info:
            print(f"{result['Name']}: {result['Link']}")
    else:
        print("\nNo exploits found in Marc Full Disclosure.")
